...
const SearchBar = ({data}) => {
    ...
    // useState is a Hook in React used to create and manage state in functional components.
    // useEffect is a Hook in React that lets you run side effects (like fetching data or updating the DOM) after rendering.
    // useState stores values.
    // useEffect reacts to changes and performs actions.
